...
function Information() {
  return (
    ...
    <div className="flex items-center justify-start flex-col text-center pt-20 pb-10 relative">
      ...
      />
      <h1 className="animate-fade-down text-4xl md:text-7xl text-gray-200 dark:text-gray-200 mb-1 md:mb-5 font-Raleway tracking-tight z-20 relative translate-y-5 sm:translate-y-5">
        Andreas Isidorsson
      </h1>
      ...
      <p className="animate-fade-down text-sm text-gray-200 dark:text-gray-200 font-Raleway tracking-tight z-20 relative translate-y-1 sm:translate-y-[10px]">
