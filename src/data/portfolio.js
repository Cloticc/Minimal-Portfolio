export default [
    {
        ...
        description: " Creating a custom user interface using the Eluna API and Lua, featuring a simple yet powerful design with the ability to customize item and spell costs for an enhanced player experience.  ",
    ...
    {
        title: "Titan-League",
        description: "A website developed for the Titan League gaming community, providing a dedicated platform for members to connect and interact on the gaming server, as well as access important updates and information.",
        imgUrl: "./assets/Titan-league.png",
        stack: [
            { name: "Vue.js", color: "#4fc08d" },
            { name: "CSS", color: "#2965f1" },
        ],
        link: "https://titans-league.org/news",
    },
